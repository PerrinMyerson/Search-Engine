...
fn render_browser_session_page_with_diagnostics(
    ...
    let _ = write!(
        chrome_tab_actions,
        r#"<div class="browser-chrome-tab-actions" data-browser-chrome-secondary-action-group="tabs" aria-label="Tab actions" data-browser-chrome-tab-actions><a href="{duplicate_href}" data-browser-chrome-duplicate-tab>Duplicate tab</a><a href="{pin_current_href}" data-browser-chrome-pin-tab>{pin_current_label}</a>"#,
    ...
    let diagnostics_section = if show_diagnostics {
        format!(
            r#"<details class="debug-stack browser-tools-menu" data-browser-tools-tray data-browser-tools-tray-role="diagnostics" data-browser-tools-tray-density="compact" data-browser-tools-tray-default="collapsed" data-browser-tools-tray-primary-flow="false">
<summary data-browser-tools-summary data-browser-tools-summary-label="Diagnostics" data-browser-tools-summary-placement="secondary">Diagnostics</summary>
...
<details class="debug-section"><summary>Links</summary><div class="debug-section-content"><div class="session-title"><h2>Links</h2><div class="resource-actions"><span class="meta">{links} found</span><a class="clear-link" href="{links_csv_href}">Links CSV</a>{links_new_sessions_control}{links_background_control}{bookmark_links_control}{remove_link_bookmarks_control}</div></div><div class="browser-actions">{link_controls}</div><ol>{link_rows}</ol></div></details>
        ...
        format!(
            r#"<div class="debug-stack browser-tools-menu browser-diagnostics-compact" data-browser-tools-tray data-browser-tools-tray-role="diagnostics-teaser" data-browser-tools-tray-density="compact" data-browser-tools-tray-primary-flow="false" data-browser-tools-teaser="compact"><span class="meta">Diagnostics and page details are available when needed.</span><a class="clear-link" href="{diagnostics_href}" data-browser-tools-teaser-link aria-label="Open browser diagnostics" title="Open browser diagnostics">Open diagnostics</a></div>"#,
...
<div class="browser-chrome-status" data-browser-chrome-status data-browser-chrome-toolbar-group role="toolbar" aria-label="Browser status and tools"{browser_chrome_status_attrs} data-browser-resource-actions data-browser-auto-visual-control>{browser_chrome_status}<a class="browser-chrome-tool" href="{tools_href}" data-browser-chrome-tools-link data-browser-chrome-tools-role="secondary" data-browser-chrome-tools-preserves="session from source viewport dimensions max-bytes" aria-label="Open secondary browser tools" title="Open secondary browser tools">Tools</a></div>
</div>
<div class="browser-location-strip" data-browser-location-strip data-browser-location-placement="under-address" data-browser-location-density="compact" data-browser-location-role="current-url" data-browser-location-route-state="stable" data-browser-location-preserves="session from source viewport dimensions max-bytes" data-browser-location-session="{id}" data-browser-location-from="{back_href}" data-browser-location-source="{source_attr}" data-browser-location-viewport-x="{viewport_x}" data-browser-location-viewport-y="{viewport_y}" data-browser-location-width="{width}" data-browser-location-height="{height}" data-browser-location-max-bytes="{max_bytes}"><strong>{heading}</strong><div class="meta" data-browser-current-location title="{source_attr}">{source}</div></div>
{primary_tab_strip}
</header>
...
fn render_browser_session_viewport_image_shell(payload: &BrowserSessionPayload) -> String {
    ...
    let viewport_accessibility_label = "Rendered browser viewport; click links and buttons in this image, or use wheel, drag, arrows, Page Up, Page Down, Home, and End to scroll";
    let scroll_line_step = (payload.height.max(1) / 6).max(1);
    let scroll_page_step_y = (payload.height.max(1) / 2).max(1);
    let scroll_page_step_x = (payload.width.max(1) / 2).max(1);
    let id_attr = html_escape::encode_double_quoted_attribute(&payload.id);
    let back_href_attr = html_escape::encode_double_quoted_attribute(&payload.back_href);
    if browser_session_pending_without_ready_viewport(payload)
    ...
    if let Some(image) = &payload.viewport_image {
        return format!(
            r#"<div class="browser-raster-shell" data-browser-viewport-scroll data-browser-dom-click data-browser-shell-interaction-mode="browser" data-browser-shell-session="{id_attr}" data-browser-shell-from="{back_href_attr}" data-browser-shell-source="{source}" data-browser-shell-viewport-x="{viewport_x}" data-browser-shell-viewport-y="{viewport_y}" data-browser-shell-width="{viewport_width}" data-browser-shell-height="{viewport_height}" data-browser-shell-max-bytes="{max_bytes}" data-browser-shell-state-contract="session from source viewport dimensions max-bytes" data-browser-shell-preserves="session from source viewport max-bytes" data-browser-shell-navigation-preserves="session source viewport max-bytes" data-browser-shell-click-scroll-separation="defer-click-during-scroll" data-browser-drag-click-suppression="after-drag" data-browser-edge-scroll-state="idle" data-browser-click-miss-state="idle" data-click-coordinate-space="raster-pixels" data-page-source="{source}" data-scroll-url="{scroll_url}" data-browser-scroll-action-url="{scroll_url}" data-browser-scroll-session="{id_attr}" data-browser-scroll-from="{back_href_attr}" data-browser-scroll-source="{source}" data-browser-scroll-viewport-x="{viewport_x}" data-browser-scroll-viewport-y="{viewport_y}" data-browser-scroll-width="{viewport_width}" data-browser-scroll-height="{viewport_height}" data-browser-scroll-max-bytes="{max_bytes}" data-browser-scroll-preserves="session from source viewport max-bytes" data-browser-wheel-scroll-mode="coalesced" data-browser-scroll-coalescing="queued-target" data-browser-scroll-flush-delay-ms="18" data-browser-scroll-input-sources="wheel keyboard controls drag" data-browser-drag-scroll-mode="pointer-pan" data-browser-drag-scroll-owner="viewport" data-browser-drag-scroll-threshold="4" data-browser-scroll-input-source="idle" data-browser-scroll-line-step="{scroll_line_step}" data-browser-scroll-page-step-x="{scroll_page_step_x}" data-browser-scroll-page-step-y="{scroll_page_step_y}" data-click-url="{click_url}" data-browser-click-action-url="{click_url}" data-browser-click-session="{id_attr}" data-browser-click-from="{back_href_attr}" data-browser-click-source="{source}" data-browser-click-viewport-x="{viewport_x}" data-browser-click-viewport-y="{viewport_y}" data-browser-click-width="{viewport_width}" data-browser-click-height="{viewport_height}" data-browser-click-max-bytes="{max_bytes}" data-browser-click-preserves="session from source viewport max-bytes" data-browser-click-action-state="idle" data-browser-click-navigation-state="ready" data-browser-click-target-context="viewport" data-browser-click-feedback-mode="compact" data-browser-click-route-contract="session from source viewport dimensions max-bytes" data-browser-click-miss-feedback="compact" data-browser-click-route-state="ready" data-browser-scroll-continuity-contract="queued-target clamp edge-feedback preserve-session" data-viewport-state="settled" data-viewport-x="{viewport_x}" data-viewport-y="{viewport_y}" data-viewport-width="{viewport_width}" data-viewport-height="{viewport_height}" data-max-bytes="{max_bytes}" data-raster-width="{width}" data-raster-height="{height}" data-max-scroll-x="{max_scroll_x}" data-max-scroll-y="{max_scroll_y}" data-settled-viewport-x="{viewport_x}" data-settled-viewport-y="{viewport_y}" tabindex="0" role="region" aria-label="{viewport_accessibility_label}" title="{viewport_accessibility_label}"><img class="browser-raster" src="{src}" width="{width}" height="{height}" alt="Rendered browser viewport; click links and buttons in the image to activate DOM elements"><span class="browser-click-marker" data-browser-click-marker hidden></span></div>"#,
            ...
            max_scroll_x = payload.max_scroll_x,
            max_scroll_y = payload.max_scroll_y,
            scroll_line_step = scroll_line_step,
            scroll_page_step_x = scroll_page_step_x,
            scroll_page_step_y = scroll_page_step_y,
    ...
    if payload.fast_scroll {
        return format!(
            r#"<div class="browser-raster-shell" data-browser-viewport-scroll data-browser-dom-click data-browser-fast-scroll data-browser-shell-interaction-mode="browser" data-browser-shell-session="{id_attr}" data-browser-shell-from="{back_href_attr}" data-browser-shell-source="{source}" data-browser-shell-viewport-x="{viewport_x}" data-browser-shell-viewport-y="{viewport_y}" data-browser-shell-width="{viewport_width}" data-browser-shell-height="{viewport_height}" data-browser-shell-max-bytes="{max_bytes}" data-browser-shell-state-contract="session from source viewport dimensions max-bytes" data-browser-shell-preserves="session from source viewport max-bytes" data-browser-shell-navigation-preserves="session source viewport max-bytes" data-browser-shell-click-scroll-separation="defer-click-during-scroll" data-browser-drag-click-suppression="after-drag" data-browser-edge-scroll-state="idle" data-browser-click-miss-state="idle" data-page-source="{source}" data-scroll-url="{scroll_url}" data-browser-scroll-action-url="{scroll_url}" data-browser-scroll-session="{id_attr}" data-browser-scroll-from="{back_href_attr}" data-browser-scroll-source="{source}" data-browser-scroll-viewport-x="{viewport_x}" data-browser-scroll-viewport-y="{viewport_y}" data-browser-scroll-width="{viewport_width}" data-browser-scroll-height="{viewport_height}" data-browser-scroll-max-bytes="{max_bytes}" data-browser-scroll-preserves="session from source viewport max-bytes" data-browser-wheel-scroll-mode="coalesced" data-browser-scroll-coalescing="queued-target" data-browser-scroll-flush-delay-ms="18" data-browser-scroll-input-sources="wheel keyboard controls drag" data-browser-drag-scroll-mode="pointer-pan" data-browser-drag-scroll-owner="viewport" data-browser-drag-scroll-threshold="4" data-browser-scroll-input-source="idle" data-browser-scroll-line-step="{scroll_line_step}" data-browser-scroll-page-step-x="{scroll_page_step_x}" data-browser-scroll-page-step-y="{scroll_page_step_y}" data-click-url="{click_url}" data-browser-click-action-url="{click_url}" data-browser-click-session="{id_attr}" data-browser-click-from="{back_href_attr}" data-browser-click-source="{source}" data-browser-click-viewport-x="{viewport_x}" data-browser-click-viewport-y="{viewport_y}" data-browser-click-width="{viewport_width}" data-browser-click-height="{viewport_height}" data-browser-click-max-bytes="{max_bytes}" data-browser-click-preserves="session from source viewport max-bytes" data-browser-click-action-state="idle" data-browser-click-navigation-state="ready" data-browser-click-target-context="viewport" data-browser-click-feedback-mode="compact" data-browser-click-route-contract="session from source viewport dimensions max-bytes" data-browser-click-miss-feedback="compact" data-browser-click-route-state="ready" data-browser-scroll-continuity-contract="queued-target clamp edge-feedback preserve-session" data-viewport-state="settled" data-viewport-x="{viewport_x}" data-viewport-y="{viewport_y}" data-viewport-width="{viewport_width}" data-viewport-height="{viewport_height}" data-max-bytes="{max_bytes}" data-max-scroll-x="{max_scroll_x}" data-max-scroll-y="{max_scroll_y}" data-settled-viewport-x="{viewport_x}" data-settled-viewport-y="{viewport_y}" tabindex="0" role="region" aria-label="{viewport_accessibility_label}" title="{viewport_accessibility_label}"><div class="browser-raster-placeholder"><strong>Fast text scroll</strong><span>Skipped visual raster generation for this scroll response. Use Refresh viewport or Make page readable to render the visual view.</span></div></div>"#,
            scroll_url = html_escape::encode_double_quoted_attribute(&scroll_url),
            click_url = html_escape::encode_double_quoted_attribute(&click_url),
            source = html_escape::encode_double_quoted_attribute(&payload.source),
            viewport_accessibility_label =
...
(() => {
  ...
  const setPendingViewportTarget = (target) => {
    ...
    if (status) {
      ...
      status.dataset.browserViewportInputSource = shell.dataset.scrollInputSource || "manual";
    }
  };
  ...
  const clearViewportPending = () => {
    ...
    if (topStatus) {
      ...
      topStatus.removeAttribute("data-browser-chrome-form-pending-viewport-y");
      topStatus.removeAttribute("data-browser-chrome-form-pending-source");
      topStatus.removeAttribute("data-browser-chrome-form-pending-max-bytes");
  ...
  const stampCurrentViewportUrl = (url) => {
    ...
    if (shell.dataset.maxBytes) {
      url.searchParams.set("max_bytes", shell.dataset.maxBytes);
    }
  ...
  const syncChromeViewportState = () => {
    ...
    for (const link of document.querySelectorAll("a[data-browser-form-submit-link]")) {
      if (!link.href) {
        continue;
      }
      const url = stampCurrentViewportUrl(new URL(link.href, window.location.href));
      link.href = url.toString();
      link.dataset.browserFormSubmitHref = url.toString();
      link.dataset.browserFormSubmitPreservedViewportX = currentX;
  ...
  const browserActionFromLink = (link) => {
    ...
    if (link.dataset.browserFormSubmitLink) {
      return "form-" + link.dataset.browserFormSubmitLink;
    }
  ...
  const markBrowserActionPending = (link) => {
    ...
    if (topStatus) {
      ...
      if (link.dataset.browserFormSubmitLink) {
        topStatus.dataset.browserChromeFormPendingState = "pending";
        topStatus.dataset.browserChromeFormPendingAction = action;
        topStatus.dataset.browserChromeFormPendingViewportX = String(numberData("viewportX"));
        topStatus.dataset.browserChromeFormPendingViewportY = String(numberData("viewportY"));
        topStatus.dataset.browserChromeFormPendingSource = shell.dataset.pageSource || "";
        topStatus.dataset.browserChromeFormPendingMaxBytes = shell.dataset.maxBytes || "";
        link.dataset.browserFormSubmitPendingState = "pending";
        link.dataset.browserFormSubmitPendingViewportX = String(numberData("viewportX"));
        link.dataset.browserFormSubmitPendingViewportY = String(numberData("viewportY"));
        link.dataset.browserFormSubmitPendingSource = shell.dataset.pageSource || "";
        link.dataset.browserFormSubmitPendingMaxBytes = shell.dataset.maxBytes || "";
      }
    }
  };
  const formActionFromSubmitter = (form, submitter) => {
    if (submitter && submitter.dataset.browserAddressSubmit) {
      return submitter.dataset.browserAddressSubmit;
    }
    if (submitter && submitter.dataset.browserFormSubmit) {
      return submitter.dataset.browserFormSubmit;
    }
    if (form && form.dataset.browserFormAction) {
      return form.dataset.browserFormAction;
    }
    return "form";
  };
  const markBrowserFormPending = (form, submitter) => {
    if (!form) {
      return;
    }
    syncChromeViewportState();
    const action = formActionFromSubmitter(form, submitter);
    form.dataset.browserFormPendingState = "pending";
    form.dataset.browserFormPendingAction = action;
    form.dataset.browserFormPendingViewportX = String(numberData("viewportX"));
    form.dataset.browserFormPendingViewportY = String(numberData("viewportY"));
    form.dataset.browserFormPendingSource = shell.dataset.pageSource || "";
    form.dataset.browserFormPendingMaxBytes = shell.dataset.maxBytes || "";
    if (submitter) {
      submitter.dataset.browserFormSubmitPending = "true";
      submitter.dataset.browserFormSubmitPendingAction = action;
      submitter.dataset.browserFormSubmitPendingState = "pending";
      submitter.dataset.browserFormSubmitPendingViewportX = String(numberData("viewportX"));
      submitter.dataset.browserFormSubmitPendingViewportY = String(numberData("viewportY"));
      submitter.dataset.browserFormSubmitPendingSource = shell.dataset.pageSource || "";
      submitter.dataset.browserFormSubmitPendingMaxBytes = shell.dataset.maxBytes || "";
    }
    const topStatus = chromeStatus();
    if (topStatus) {
      topStatus.dataset.browserChromePendingState = "pending";
  ...
  document.addEventListener("submit", (event) => {
    ...
    if (!form || !form.matches("form[action=\"/browser\"]")) {
      return;
    }
    markBrowserFormPending(form, event.submitter instanceof HTMLElement ? event.submitter : null);
  });
  document.addEventListener("click", (event) => {
    const eventTarget = event.target instanceof Element ? event.target : event.target && event.target.parentElement;
    const link = eventTarget && typeof eventTarget.closest === "function"
      ? eventTarget.closest("a[data-browser-primary-nav-action], a[data-browser-chrome-current-action], a[data-browser-chrome-reload-action], a[data-browser-chrome-images-action], a[data-browser-form-submit-link]")
      : null;
    if (!link) {
      return;
    }
  ...
  const submitViewportClick = (point, messagePrefix) => {
    ...
    shell.dataset.clickActionState = "pending";
    shell.dataset.clickNavigationState = "submitting";
    shell.dataset.clickTargetContext = "viewport";
    shell.dataset.clickPreservedViewportX = String(numberData("viewportX"));
    shell.dataset.clickPreservedViewportY = String(numberData("viewportY"));
  ...
  const syncViewportHistory = () => {
    ...
    try {
      ...
      currentUrl.searchParams.set("width", String(numberData("viewportWidth")));
      currentUrl.searchParams.set("height", String(numberData("viewportHeight")));
      if (shell.dataset.maxBytes) {
        currentUrl.searchParams.set("max_bytes", shell.dataset.maxBytes);
      }
      if (shell.dataset.pageSource) {
        currentUrl.searchParams.set("source", shell.dataset.pageSource);
      }
  ...
  const scrollFlushDelayMs = clamp(Number(shell.dataset.browserScrollFlushDelayMs) || 18, 0, 120);
  ...
  const queueViewportScroll = (dx, dy, inputSource = "manual") => {
    ...
    shell.dataset.queuedScrollTargetX = String(pending.x);
    shell.dataset.queuedScrollTargetY = String(pending.y);
  ...
  shell.addEventListener("wheel", (event) => {
    ...
    if (dx || dy) {
      event.preventDefault();
      queueViewportScroll(dx, dy, "wheel");
    }
  }, { passive: false });
  let dragScrollStart = null;
  let suppressNextClickAfterDrag = false;
  const dragScrollThreshold = () => clamp(Number(shell.dataset.browserDragScrollThreshold) || 4, 1, 32);
  shell.addEventListener("pointerdown", (event) => {
    if (event.button !== 0 || event.defaultPrevented || event.target !== shell && event.target !== raster) {
      return;
    }
  ...
  shell.addEventListener("pointermove", (event) => {
    ...
    const dx = Math.round(dragScrollStart.x - event.clientX);
    const dy = Math.round(dragScrollStart.y - event.clientY);
    if (Math.abs(dx) < dragScrollThreshold() && Math.abs(dy) < dragScrollThreshold()) {
      return;
    }
    event.preventDefault();
  ...
  shell.addEventListener("click", (event) => {
    if (suppressNextClickAfterDrag) {
      ...
      shell.dataset.clickActionState = "suppressed-after-drag";
      shell.dataset.clickNavigationState = "suppressed";
      const suppressedTopStatus = chromeStatus();
      if (suppressedTopStatus) { suppressedTopStatus.dataset.browserChromeClickRouteState = "suppressed-after-drag"; }
    ...
    if (!point) {
      ...
      shell.dataset.clickMissViewportX = String(numberData("viewportX"));
      shell.dataset.clickMissViewportY = String(numberData("viewportY"));
      shell.dataset.clickMissSource = shell.dataset.pageSource || "";
      shell.dataset.clickMissMaxBytes = shell.dataset.maxBytes || "";
      const topStatus = chromeStatus();
      if (topStatus) {
        topStatus.dataset.browserChromeClickMissState = "missed";
        topStatus.dataset.browserChromeClickMissReason = "outside-raster";
        topStatus.dataset.browserChromeClickRouteState = "missed";
        topStatus.dataset.browserChromeClickMissViewportX = String(numberData("viewportX"));
        topStatus.dataset.browserChromeClickMissViewportY = String(numberData("viewportY"));
        topStatus.dataset.browserChromeClickMissSource = shell.dataset.pageSource || "";
        topStatus.dataset.browserChromeClickMissMaxBytes = shell.dataset.maxBytes || "";
      }
    ...
    shell.removeAttribute("data-click-miss-viewport-x");
    shell.removeAttribute("data-click-miss-viewport-y");
    shell.removeAttribute("data-click-miss-source");
    shell.removeAttribute("data-click-miss-max-bytes");
    const topStatus = chromeStatus();
    if (topStatus) {
      ...
      topStatus.removeAttribute("data-browser-chrome-click-miss-viewport-x");
      topStatus.removeAttribute("data-browser-chrome-click-miss-viewport-y");
      topStatus.removeAttribute("data-browser-chrome-click-miss-source");
      topStatus.removeAttribute("data-browser-chrome-click-miss-max-bytes");
      topStatus.dataset.browserChromeClickRouteState = "ready";
    }
    ...
    if (viewportWorkPending()) {
      ...
      shell.dataset.clickActionState = "deferred";
      shell.dataset.clickNavigationState = "waiting-for-viewport";
      const deferredTopStatus = chromeStatus();
      if (deferredTopStatus) { deferredTopStatus.dataset.browserChromeClickRouteState = "waiting-for-viewport"; }
  ...
  document.addEventListener("click", (event) => {
    ...
    if (scrollDelta) {
      queueViewportScroll(scrollDelta.dx, scrollDelta.dy, "controls");
      return;
    }
  ...
  const keyboardDelta = (event) => {
    ...
    const pageY = Math.max(1, Math.round(numberData("browserScrollPageStepY")) || Math.floor(numberData("viewportHeight") / 2));
    const pageX = Math.max(1, Math.round(numberData("browserScrollPageStepX")) || Math.floor(numberData("viewportWidth") / 2));
    let dx = 0;
    let dy = 0;
...
fn browser_session_chrome_page_action_state_attrs(
    ...
    format!(
        r#" data-browser-chrome-{action}-href="{href}" data-browser-chrome-{action}-session="{id}" data-browser-chrome-{action}-from="{from}" data-browser-chrome-{action}-source="{source}" data-browser-chrome-{action}-viewport-x="{viewport_x}" data-browser-chrome-{action}-viewport-y="{viewport_y}" data-browser-chrome-{action}-width="{width}" data-browser-chrome-{action}-height="{height}" data-browser-chrome-{action}-max-bytes="{max_bytes}" data-browser-chrome-{action}-availability="available" data-browser-chrome-{action}-pending-state="idle" data-browser-chrome-{action}-role="page" data-browser-chrome-{action}-preserves="session from source viewport dimensions max-bytes""#,
        action = action,
        href = html_escape::encode_double_quoted_attribute(href),
        id = html_escape::encode_double_quoted_attribute(&payload.id),
        from = html_escape::encode_double_quoted_attribute(back_href),
...
fn render_browser_session_chrome_image_action(
    ...
    format!(
        r#"<a class="browser-chrome-tool" href="{href}" data-browser-resource-action data-browser-chrome-images-action{image_action_attrs} data-browser-resource-status="Loading images..." aria-label="Load images for current page" title="Load images for current page">Images</a>"#,
        href = html_escape::encode_double_quoted_attribute(href),
...
fn render_browser_session_viewport_status(payload: &BrowserSessionPayload) -> String {
    ...
    format!(
        r#"<div class="viewport-status compact" data-browser-viewport-status data-browser-first-view-status="compact" data-browser-viewport-status-density="compact" data-browser-viewport-status-role="compact-scroll-feedback" data-browser-viewport-status-primary-flow="true" data-browser-viewport-status-debug-flow="none" data-browser-viewport-status-preserves="session from source viewport dimensions max-bytes" data-browser-viewport-status-session="{id}" data-browser-viewport-status-from="{back_href}" data-browser-viewport-status-source="{source}" data-browser-viewport-status-width="{width}" data-browser-viewport-status-height="{height}" data-browser-viewport-status-max-bytes="{max_bytes}" data-browser-viewport-status-scroll-state="idle" data-browser-viewport-status-click-state="ready" data-browser-viewport-status-layout="summary feedback meter" data-browser-viewport-status-visible-budget="summary feedback meter" data-browser-viewport-status-current-target="current target max" data-browser-viewport-feedback-lanes="scroll click" data-browser-viewport-pending-state="idle" data-browser-viewport-target-x="{x}" data-browser-viewport-target-y="{y}" data-browser-viewport-current-x="{x}" data-browser-viewport-current-y="{y}" data-browser-viewport-max-x="{max_x}" data-browser-viewport-max-y="{max_y}" data-browser-viewport-input-sources="wheel keyboard controls drag"{action_state_attrs}><div class="viewport-status-text"><span class="viewport-scroll-summary" data-browser-scroll-state="summary" data-scroll-x-state="{horizontal_state}" data-scroll-y-state="{vertical_state}">{scroll_summary}</span><span data-browser-scroll-input-hint hidden>{input_hint}</span><span class="viewport-scroll-feedback" data-browser-viewport-feedback aria-live="polite">{viewport_feedback}</span><span class="viewport-state-chip" data-browser-click-status aria-live="polite">{click_status}</span><span data-browser-click-hint hidden>{click_hint}</span></div><div class="viewport-scroll-meter" role="progressbar" aria-label="Vertical scroll position" aria-valuemin="0" aria-valuemax="{max_y}" aria-valuenow="{y}" aria-valuetext="y {y} of {max_y}"><span style="width: {meter_percent}%;"></span></div></div>"#,
        id = html_escape::encode_double_quoted_attribute(&payload.id),
...
fn render_browser_session_forms(payload: &BrowserSessionPayload) -> String {
    ...
    for form in &payload.forms {
        let _ = write!(
            rows,
            r#"<section class="browser-form" data-browser-form-tools="secondary" data-browser-form-index="{index}" data-browser-form-action="submit" data-browser-form-session="{id}" data-browser-form-from="{back_href}" data-browser-form-source="{source_attr}" data-browser-form-viewport-x="{viewport_x}" data-browser-form-viewport-y="{viewport_y}" data-browser-form-width="{width}" data-browser-form-height="{height}" data-browser-form-max-bytes="{max_bytes}"><h3>Form {index}</h3><div class="details">{method} · {action}</div>"#,
            index = form.index,
        ...
        let _ = write!(
            rows,
            r#"<div class="control"><label>Submit</label><div class="details">{method} {target}</div><div class="resource-actions"><a class="small-action" href="{href}" data-browser-form-submit-link="submit" data-browser-form-submit-href="{href}" data-browser-form-submit-session="{id}" data-browser-form-submit-from="{back_href}" data-browser-form-submit-source="{source_attr}" data-browser-form-submit-viewport-x="{viewport_x}" data-browser-form-submit-viewport-y="{viewport_y}" data-browser-form-submit-width="{width}" data-browser-form-submit-height="{height}" data-browser-form-submit-max-bytes="{max_bytes}" data-browser-form-submit-pending-state="idle">Submit form</a><a class="small-action" href="{new_href}" data-browser-form-submit-link="submit-new-session" data-browser-form-submit-href="{new_href}" data-browser-form-submit-session="{id}" data-browser-form-submit-from="{back_href}" data-browser-form-submit-source="{source_attr}" data-browser-form-submit-viewport-x="{viewport_x}" data-browser-form-submit-viewport-y="{viewport_y}" data-browser-form-submit-width="{width}" data-browser-form-submit-height="{height}" data-browser-form-submit-max-bytes="{max_bytes}" data-browser-form-submit-pending-state="idle">New session</a><a class="small-action" href="{background_href}" data-browser-form-submit-link="submit-background-session" data-browser-form-submit-href="{background_href}" data-browser-form-submit-session="{id}" data-browser-form-submit-from="{back_href}" data-browser-form-submit-source="{source_attr}" data-browser-form-submit-viewport-x="{viewport_x}" data-browser-form-submit-viewport-y="{viewport_y}" data-browser-form-submit-width="{width}" data-browser-form-submit-height="{height}" data-browser-form-submit-max-bytes="{max_bytes}" data-browser-form-submit-pending-state="idle">Background</a></div></div></section>"#,
            method = html_escape::encode_text(&form.method.to_ascii_uppercase()),
...
fn render_browser_session_control(
    ...
    if !control.options.is_empty() {
        ...
        return format!(
            r#"<form class="control" action="/browser" method="get" data-browser-form-action="select" data-browser-form-pending-state="idle">{common}<input type="hidden" name="action" value="select"><input type="hidden" name="form" value="{form_index}"><input type="hidden" name="control" value="{control_index}"><label>{label}</label><select name="value">{options}</select><div class="resource-actions">{focus}<button type="submit">Set</button>{option_links}</div></form>"#,
            common = browser_session_common_hidden_inputs(payload),
    ...
    if control.fill_url.is_some() || control.type_url.is_some() {
        ...
        return format!(
            r#"<form class="control" action="/browser" method="get" data-browser-form-action="{action}" data-browser-form-pending-state="idle">{common}<input type="hidden" name="action" value="{action}"><input type="hidden" name="form" value="{form_index}"><input type="hidden" name="control" value="{control_index}"><label>{label}</label><input type="text" name="value" value="{value}"><div class="resource-actions">{focus}{clear}<button type="submit">{button}</button></div></form>"#,
            common = browser_session_common_hidden_inputs(payload),
            action = action,
            form_index = form.index,
            control_index = control.index,
